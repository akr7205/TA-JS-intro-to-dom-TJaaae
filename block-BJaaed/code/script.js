...
/*
 <div class="container">
      <div class="card-container flex justify-between item-center">
        <div class="card flex-30">
          <div class="img flex center">
           <img class="" src="https://eloquentjavascript.net/img/cover.jpg" alt="">
          </div>
...
cardContainer.classList.add('card-container','flex','justify-between','item-center','wrap','flex-column');
  booksData.books.forEach(book =>{
    ...
    a.classList.add('btn');
    a.innerText='Buy Now';
    bookContent.append(h2,p,a);
    card.append(bookContent);
